...
# --- IMPORTANT: Define these paths before running --- 
...
# For editing task, only support batch_size=1 now, because the input resolution may be different for different samples
INFERENCE_BATCH_SIZE=1
DATASET_NAME=EditingSingleTurnExampleDataset # See example format: configs/data_configs/test_data_examples/EditingSingleTurnExample/edit_test_examples.jsonl
TEMPERATURE=0.7
TOP_K=512
TOP_P=0.8
LLM_CFG_SCALE=1.25
...
echo "Image editing inference finished." 