...
data_args = dict(
    ...
    train=dict(
        resolution=256,
        augment=dict(type='dualvitok_fix_resolution_train'),
...
results_dir = './logdir/dualvitok/dualvitok_fix256/'  # Directory for results
...
global_seed = 1  # Global random seed
num_workers = 8  # Number of data loading workers
log_every = 100  # Log every x iterations
ckpt_every = 5000  # Save checkpoint every x iterations
