...
model_args = dict(
    ...
    language_model=dict(
        ...
        pretrained_model_name_or_path='../checkpoints/Qwen2.5-7B-Instruct-with-vision-tokenizer-32k-96k-level2',
...
training_args = dict(
    output_dir="./logdir/illume_plus_7b/illume_plus-qwen2_5-7b_stage3/",
